-- Homepage Landing Feature Database Schema
-- This migration sets up the core tables needed for the homepage/landing page functionality
...
SELECT 
    ...
    CASE WHEN random() > 0.7 THEN 'house' ELSE 'apartment' END,
    jsonb_build_object(
