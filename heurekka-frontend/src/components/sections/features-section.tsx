...
const MeetingIllustration = () => {
    return (
        <Card
            aria-hidden
            className="mt-9 aspect-video p-4 bg-white border-gray-100/50 shadow-sm">
            ...
            <div className="mb-2 flex -space-x-1.5">
                <div className="flex -space-x-1.5">
                    {[
                        ...
                        <div
                            key={index}
                            className="bg-white size-7 rounded-full border-gray-100/50 p-0.5 shadow-sm">
                            <img
...
const CodeReviewIllustration = () => {
    return (
        <div
            ...
            <Card className="aspect-video w-4/5 translate-y-4 p-3 transition-transform duration-200 ease-in-out group-hover:-rotate-3 bg-white border-gray-100/50 shadow-sm">
                <div className="mb-3 flex items-center gap-2">
                    <div className="bg-white size-6 rounded-full border-gray-100/50 p-0.5 shadow-sm">
                        <img
                            className="aspect-square rounded-full object-cover"
                            src={MESCHAC_AVATAR}
                            alt="M Irung"
            ...
            <Card className="aspect-3/5 absolute -top-4 right-0 flex w-2/5 translate-y-4 p-2 transition-transform duration-200 ease-in-out group-hover:rotate-3 bg-white border-gray-100/50 shadow-sm">
...
const AIAssistantIllustration = () => {
    return (
        <Card
            aria-hidden
            className="mt-6 aspect-video translate-y-4 p-4 pb-6 transition-transform duration-200 group-hover:translate-y-0 bg-white border-gray-100/50 shadow-sm">
            <div className="w-fit">
